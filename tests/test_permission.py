...
class TestBasePermission:
    def test_has_permission_default_true(self):
        assert BasePermission.has_permission(MagicMock(), None) is True

    def test_has_object_permission_default_true(self):
        assert BasePermission.has_object_permission(MagicMock(), None, MagicMock()) is True


class TestAllowAny:
    def test_has_permission_true(self):
        assert AllowAny.has_permission(MagicMock(), None) is True

    def test_has_object_permission_true(self):
        assert AllowAny.has_object_permission(MagicMock(), None, MagicMock()) is True
